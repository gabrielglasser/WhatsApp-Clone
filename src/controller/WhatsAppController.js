  ...
  initEvents() {
    ...
    this.el.formPanelAddContact.on("submit", (e) => {
      ...
      contact.on("datachange", (data) => {
        if (data.name) {
          Chat.createIfNotExist(this._user.email, contact.email).then(
            (chat) => {
          ...
          console.error("Não foi possível carregar os dados do contato");
        }
      });
    });
    ...
    this.el.btnSendPicture.on("click", (e) => {
      ...
      picture.onload = () => {
        ...
        context.transform(picture.width, 0);
        context.scale(-1, 1);
        ...
        fetch(canvas.toDataURL(mimeType))
          ...
          .then((file) => {
            ...
            this.el.btnSendPicture.diseabled = false;
